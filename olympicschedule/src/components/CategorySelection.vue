<template>
  <div>
    <h2>Selecione as Modalidades</h2>
    <ul>
    ...
    <button @click="selectAll">Selecionar Todas</button>
    <button @click="clearSelection">Limpar Seleção</button>
    <button @click="updateSelectedCategories">Selecionar</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    updateSelectedCategories() {
      ...
      this.$emit("categories-updated", selectedCategories);
    },
  },
};
</script>
